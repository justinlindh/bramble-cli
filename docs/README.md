...
This folder contains operational docs plus historical implementation notes.
...
- `images/tui-overview.png` and `images/tui-chat.gif` are referenced from the project README.
- `images/*.tape` files are VHS source tapes used to regenerate demo media and are intentionally retained as source artifacts.
